...
<ul uk-accordion="multiple: true">
    <li class="uk-open">
        <a class="uk-accordion-title" href="#">24.06.2024</a>
        <div class="uk-accordion-content">
            <div class="uk-grid-match uk-child-width-1-3 uk-margin-medium" uk-grid >
                <div>
    ...
    <li class="uk-open">
        <a class="uk-accordion-title" href="#">25.04.2024</a>
        <div class="uk-accordion-content">
            <div class="uk-grid-match uk-child-width-1-3 uk-margin-medium" uk-grid >
                <div>
                    <div class="uk-card uk-card-default uk-padding-small uk-text-center">
    ...
    <li class="uk-open">
        <a class="uk-accordion-title" href="#">08.03.2024</a>
        <div class="uk-accordion-content">
            <div class="uk-grid-match uk-child-width-1-3 uk-margin-medium" uk-grid >
                <div>
                    <div class="uk-card uk-card-default uk-padding-small uk-text-center">
